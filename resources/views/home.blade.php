...
<nav >
    <div class=" sm:px-56 mx-auto font-medium  justify-between flex p-4 fixed bg-fixed bg-white top-0 right-0 left-0 overflow-hidden bg-">
        ...
        <ul class="hidden sm:flex justify-end space-x-4 font-bold gap-12">
            <li>
                <a href="">Home</a>
            </li>
            <li>
...
<div class="m-12 justify-center text-center font-semibold">
    <h2>
...
<section>
    <div class="container mx-auto flex flex-col p-4 sm:flex-row sm:left-0 sm:right-0 overflow-hidden  left-0 right-0">
